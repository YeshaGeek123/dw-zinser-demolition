<?php
/**
 * dw-zinser-demolition functions and definitions
 *
 ...
 */
function dw_zinser_demolition_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on dw-zinser-demolition, use a find and replace
		* to change 'dw-zinser-demolition' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'dw-zinser-demolition', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'dw-zinser-demolition' ),
			'footer-menu' => esc_html__( 'Footer', 'dw-zinser-demolition' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'dw_zinser_demolition_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'dw_zinser_demolition_setup' );
 ...
 */
function dw_zinser_demolition_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'dw_zinser_demolition_content_width', 640 );
}
add_action( 'after_setup_theme', 'dw_zinser_demolition_content_width', 0 );
 ...
 */
function dw_zinser_demolition_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'dw-zinser-demolition' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'dw-zinser-demolition' ),
...
add_action( 'widgets_init', 'dw_zinser_demolition_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function dw_zinser_demolition_scripts() {
	wp_enqueue_style('dw-zinser-demolition-bootstrap-min', get_template_directory_uri() . '/assets/css/bootstrap.min.css', array(), '20151215');
	wp_enqueue_style('dw-zinser-demolition-animate', get_template_directory_uri() . '/assets/css/animate.min.css', array(), '20151215');
	wp_enqueue_style('dw-zinser-demolition-slick', get_template_directory_uri() . '/assets/css/slick.css', array(), '20151215');
...
add_action( 'wp_enqueue_scripts', 'dw_zinser_demolition_scripts' );
